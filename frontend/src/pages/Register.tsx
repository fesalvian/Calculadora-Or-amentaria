      ...
      <form onSubmit={handleSubmit} style={{ marginTop: '1rem', display: 'grid', gap: '1rem' }}>
        ...
        <div>
          <label>Senha</label>
            ...
            />
            <button type="button" onClick={() => setShowPassword(v => !v)} style={{ position:'absolute', right:'0.5rem', top:'50%', transform:'translateY(-50%)', background:'none', border:'none' }}>
            {showPassword
              ?  <svg
        ...
        <div>
          <label>Confirmar Senha</label>
            ...
            <input
              ...
              style={{ paddingRight: '2.5rem', /* ... */ }}
            />
            <button type="button" onClick={() => setShowConfirm(v => !v)} style={{ position:'absolute', right:'0.5rem', top:'50%', transform:'translateY(-50%)', background:'none', border:'none' }}>
            {showConfirm
              ?  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
